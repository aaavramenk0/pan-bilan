            ...
            <div className="bg-gray-50 bg-opacity-60 lg:pb-7">
                <div className="px-5 py-3 lg:py-7 lg:px-16 lg:pt-4 text-center">
                    ...
                    <div className="text-xl font-medium text-left leading-8 flex flex-col lg:grid lg:grid-cols-1 lg:grid-rows-4 lg:gap-8 lg:leading-10">
                        <div className="flex flex-col items-center gap-4 my-4 lg:grid lg:grid-rows-1 lg:grid-cols-3 lg:gap-8 lg:justify-items-center lg:items-center">
                        ...
                        <div className="flex flex-col-reverse items-center gap-4 my-4 lg:grid lg:grid-rows-1 lg:grid-cols-3 lg:gap-8 lg:justify-items-center lg:items-center">
                            <Divider className="lg:hidden" />
                            <Image
